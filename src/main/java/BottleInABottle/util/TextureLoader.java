...
public class TextureLoader {
     ...
     *                      Example: "BottleInABottleResources/images/ui/missing_texture.png"
    ...
    public static Texture getTexture(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                ...
                return getTexture("BottleInABottleResources/images/ui/missing_texture.png");
            }
        }
    ...
    /**
     * Checks if a given texture recourse path exists
     *
     * @param textureString - String path to the texture you want to check.
     *                      Example: "img/ui/missingtexture.png"
     */
    public static boolean checkTexture(String textureString) {
        return TextureLoader.class.getResource(textureString) != null;
    }
    ...
    private static void loadTexture(final String textureString) throws GdxRuntimeException {
        logger.info("BottleInABottle | Loading Texture: " + textureString);
