package BottleInABottle.relics.DefaultMod;
...
import BottleInABottle.patches.relics.BottledPlaceholderField;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = BottleInABottle.makeID("BottledPlaceholderRelic");
