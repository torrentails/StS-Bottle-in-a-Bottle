package BottleInABottle.powers;
...
public class RarePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = BottleInABottle.makeID("RarePower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(
            "BottleInABottleResources/images/powers/placeholder_power84.png");
    private static final Texture tex32 = TextureLoader.getTexture(
            "BottleInABottleResources/images/powers/placeholder_power32.png");
    ...
    public void atStartOfTurn() { // At the start of your turn
        AbstractCard playCard = new Paradox(); // Declare Card - the DefaultRareAttack card. We will name it 'playCard'.
