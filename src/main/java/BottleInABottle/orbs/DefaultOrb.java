...
import static BottleInABottle.BottleInABottle.makeOrbPath;

public class DefaultOrb extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = BottleInABottle.makeID("DefaultOrb");
